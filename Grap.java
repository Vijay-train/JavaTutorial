...
import java.util.Comparator;
 /* 
 FRI
 1) Detect a Cycle in an Undirected Graph    both BFS/DFS  
 2) Bipartite Graph both (BFS/DFS) 
 */ 
 
 /*
 SAT
 "3) Topological Sort / Kahn's Algorithm                                                                                                            
  4) Detect a cycle in Directed Graph both BFS/DFS "
 
/* 
Sun
5) Shortest Path in Undirected Graph with Unit Weight
6) Dijkstra's Algorithm  Using Priority Queue
7) Dijkstra's Algorithm Using Set                                                "
 */
...
public class Grap{
    ...
    * m(edges) = 4
    * 
    * if vertic ct = (edge ct - 1) -> not a cycle
    * else
    * // cycle
    * 
    *   0
    ...
    *  1) enq 0 , mark visited[0] = T, parent[0] = -1, enqueue 0
    *     queue = [0]
    *     visited = [T, F, F, F]
    *     parent  = [-1, -1, -1, -1]
    *
    ...
    * ancestor and thus indicates a cycle in an undirected graph.
     ...
     *
        ...
        *       0 (R)
        *      / \
        *     1 (B)---2   -> impossible to 2-color (odd cycle)
        *
     * Approach:
    ...
    * 
    *  - Dequeue 0: neighbor 1 uncolored -> color[1] = 1, enqueue 1
    *    queue = [1], color = [0, 1, -1, -1]
    * 
    *  - Dequeue 1: neighbors 0 (color 0 OK), 2 uncolored -> color[2] = 0, enqueue 2
    *    queue = [2], color = [0, 1, 0, -1]
    * 
    *  - Dequeue 2: neighbors 1 (1 OK), 3 uncolored -> color[3] = 1, enqueue 3
    *    queue = [3], color = [0, 1, 0, 1]
    * 
    *  - Dequeue 3: neighbor 2 (0 OK)
    ...
    * 
    *  - Dequeue 11: neighbor 10 (0 OK).    (Different than what was dequeued)
